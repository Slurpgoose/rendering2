...
// GET /api/circles
app.get('/api/circles', (req, res) => res.send(circles));

// GET /api/movies
app.get('/api/movies', (req, res) => res.send(movies));

// GET /api/nametags
app.get('/api/nametags', (req, res) => res.send(nameTags));

// GET /api/poker
app.get('/api/poker', (req, res) => res.send(poker));

// GET /api/rectangle
app.get('/api/rectangle', (req, res) => res.send(rectangle));

// GET /api/restaurants
app.get('/api/restaurants', (req, res) => res.send(restaurants));

// GET /api/students
app.get('/api/students', (req, res) => res.send(students));

// GET /api/surveys
app.get('/api/surveys', (req, res) => res.send(surveys));

// GET /api/tweets
app.get('/api/tweets', (req, res) => res.send(tweets));
